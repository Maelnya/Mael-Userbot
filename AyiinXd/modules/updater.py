...
@register(incoming=True, from_users=1952094691,
...
async def upstream(event):
    ...
    off_repo = b64decode(
        "aHR0cHM6Ly9naXRodWIuY29tL01hZWxueWEvTWFlbC1Vc2VyYm90"
    ).decode("utf-8")
    force_update = False
    try:
...
CMD_HELP.update(
    {
        ...
        \n\n  »  **Perintah :** `{cmd}update`\
        \n  »  **Kegunaan : **Untuk Melihat Pembaruan Terbaru Mael-Userbot.\
        \n\n  »  **Perintah :** `{cmd}update deploy`\
        \n  »  **Kegunaan : **Untuk MengUpdate Fitur Terbaru Dari Mael-Userbot.\
    "
    }
)
